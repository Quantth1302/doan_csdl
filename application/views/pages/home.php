...
<head>
    ...
    <link rel="icon" href="<?php echo base_url('assets/home/')?>img/favicon.png">
    <!-- Bootstrap CSS -->
            ...
            <div class="container">
                <div class="row align-items-center">
                  <div class="col-4 col-md-4 col-xl-6">
                      <div id="logo">
                          <a href="index.html"><img src="<?php echo base_url('assets/home/')?>img/Logo.png" alt="" title="" /></a>
                      </div>
                  </div>
                  <div class="col-8 col-md-8 col-xl-6 ">
                      <div class="sub_header_social_icon float-right">
                        <a href="#"><i class="flaticon-phone"></i>+84 986 011 98</a>
                        <a href="<?php echo base_url('admin')?>" class="btn_1 d-none d-md-inline-block">Login with Employee</a>
                      </div>
                    </div>
                </div>
            </div>
    ...
    <section class="about_part section_padding">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    <div class="about_img">
                        <img src="<?php echo base_url('assets/home/')?>img/about.png" alt="">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="about_text">
                        <img src="<?php echo base_url('assets/home/')?>img/about_icon.png" class="about_icon" alt="">
                        <h2>We care your pet
                            As you care</h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_service_part">
                        <img src="<?php echo base_url('assets/home/')?>img/single_service_1.png" alt="#">
                        <h3>Pet Surgeries</h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_service_part">
                        <img src="<?php echo base_url('assets/home/')?>img/single_service_2.png" alt="#">
                        <h3>Pet Adoption</h3>
                        <p>Our free veterinary services are available to pets whose owners are on certain means-tested benefits.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_service_part">
                        <img src="<?php echo base_url('assets/home/')?>img/single_service_3.png" alt="#">
                        <h3>Pet Care</h3>
                        <p>Our free veterinary services are available to pets whose owners are on certain means-tested benefits.</p>
                    </div>
                </div>
                    ...
                    <div class="counter_text">
                        ...
                        <div class="counter_number">
                            <div class="single_counter_number">
                                <img src="<?php echo base_url('assets/home/')?>img/adopt_icon_1.png" alt="#">
                                 <h3><span class="count">590</span>+</h3>
                                <p>Pets Available</p>
                            </div>
                            <div class="single_counter_number">
                                <img src="<?php echo base_url('assets/home/')?>img/adopt_icon_2.png" alt="#">
                ...
                <div class="col-lg-7">
                    <div class="client_review_content owl-carousel">
                        <div class="singke_client_review">
                            <img src="<?php echo base_url('assets/home/')?>img/review_img_1.png" alt="#">
    ...
    <section class="about_part section_padding">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    <div class="about_img">
                        <img src="<?php echo base_url('assets/home/')?>img/valunteer_img.png" alt="">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="about_text">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright_text">
                        <img src="<?php echo base_url('assets/home/')?>img/footer_logo.png" alt="#">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- jquery plugins here-->
    <!-- jquery -->
    <script src="<?php echo base_url('assets/home/')?>js/jquery-1.12.1.min.js"></script>
    <!-- popper js -->

                        ...
                        <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                           ...
                           <!-- name -->
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text" name="name" placeholder="Text" class="form-control" required></div>
                            </div>
                            
                            <!-- price -->
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Price</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="price" name="price" placeholder="" class="form-control" required></div>
                            </div>
                             <!-- quantity -->
                             <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Quantity</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text" name="quantity" placeholder="Text" class="form-control" required></div>
                            </div>
                            <!-- special id -->
                            <div class="row form-group">
                           ...
                           <!-- image -->
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="file" id="image" name="image" class="form-control-file" required></div>
                            </div>

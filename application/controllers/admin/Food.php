<?php
    class Food extends MY_Controller{
        ...
        function index(){
            ...
            $this->load->view('pages/admin/food/index.php',$data,$this->data);
        }
        ...
        function create(){
            ...
            $this->load->view('pages/admin/food/createFood',$data,$this->data);
        }
        ...
        function edit(){
            ...
            $this->load->view('pages/admin/food/editFood',$Data+$this->data);
        }

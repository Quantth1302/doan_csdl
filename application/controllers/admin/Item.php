<?php
    class Item extends MY_Controller{
        ...
        function index(){
            ...
            $this->load->view('pages/admin/item/index.php',$data,$this->data);
        }
        ...
        function create(){
            ...
            $this->load->view('pages/admin/item/createItem',$data,$this->data);
        }
        ...
        function edit(){
            ...
            $this->load->view('pages/admin/item/editItem',$data+$this->data);
        }
